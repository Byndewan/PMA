        ...
        <div class="bg-white rounded-lg p-5 shadow-sm border border-gray-100">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl font-semibold text-gray-800">{{ $orders->where('status', 'pending')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg p-5 shadow-sm border border-gray-100">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xl font-semibold text-gray-800">{{ $orders->where('status', 'completed')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <div class="p-4 hover:bg-gray-50 transition-colors">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('customer.orders.show', $order) }}" class="text-blue-500 hover:text-blue-700">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-8 text-center">
                ...
                <a href="{{ route('customer.products.index') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                    Pesan Sekarang
                </a>
            </div>
            @endforelse
        ...
        <div class="p-4 border-t border-gray-100 text-right">
            <a href="{{ route('customer.orders.index') }}" class="text-sm font-medium text-blue-500 hover:text-blue-700">
                Lihat semua pesanan
            </a>
        </div>
        @endif
