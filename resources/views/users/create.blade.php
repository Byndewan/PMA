...
<form action="{{ route('users.store') }}" method="POST">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-lg border border-gray-100 p-4 shadow-xs" x-data="{ role: '' }" x-effect="role = document.getElementById('role').value">
            <div x-show="role === 'operator'">
                <h3 class="text-lg font-semibold mb-4 text-gray-800">Saldo Operator</h3>
                <div>
                    <label for="balance" class="block mb-1.5 text-sm font-medium text-gray-700">Saldo Awal</label>
